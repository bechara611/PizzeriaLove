...
const Galeria = () => {
    ...
    <div className="row my-4 ">
        <div className="col-lg-4">
           ...
           < img src={Pizza5} alt="" className="img-fluid Img-responsive cardcitaImagen"></img>
            </div> 
        </div>
        <div className="col-lg-4">
            <div className="card cardcita">
           < img src={Pizza2} alt="" className="img-fluid Img-responsive cardcitaImagen"></img>
            </div>
        </div>
        <div className="col-lg-4">
            <div className="card cardcita">
           < img src={Pizza3} alt="" className="img-fluid Img-responsive cardcitaImagen"></img>
            </div>
        </div>
    </div>
