...
const Header = () => {
    ...
    url1="/inicio";
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0 header_menu">
        <li className="nav-item"><BotonTipoNavLinkA to={url1} className="nav-link btn-dark"><Inicio2/> Inicio</BotonTipoNavLinkA></li> 
        <li className="nav-item"><a href="#menuu" className="nav-link btn-dark opcion"><Menu2></Menu2> Menú</a></li>
