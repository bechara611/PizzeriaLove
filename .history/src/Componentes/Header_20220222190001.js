...
const Header = ({cambiaradministrador},{administrador}) => {
    let url1,urladmin;
    url1="/inicio";
    urladmin='/administrador'
      ...
      <li className="nav-item opcion"><a href="#menuu" className="nav-link text-light  opcion"><Menu2></Menu2> Menú</a></li>
        <li className="nav-item"><BotonTipoNavLinkA to={url1} className="nav-link"><Inicio2/> Inicio</BotonTipoNavLinkA></li> 
        <li className="nav-item"><BotonTipoNavLink to={url1} className="nav-link"> <Contacto2 /> Contacto</BotonTipoNavLink></li>
        <li className="nav-item"><BotonTipoNavLink to={urladmin} className="nav-link"> <Administrador2 /> Administrador</BotonTipoNavLink></li>
      </ul>
