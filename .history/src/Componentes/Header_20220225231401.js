    ...
    urladmin='/administrador'
      return (
        ...
        <div className='hijo1_header'>
         <BotonTipoNavLink to={url1} className="navbar-brand col-12"> <Heart2 / > PizzeriaLove <Pizza2></Pizza2></BotonTipoNavLink> 
      ...
      <div className="collapse navbar-collapse col-12" id="menu">
