...
const Header = ({cambiaradministrador,administrador,cambiaradmin}) => {
    ...
    urladmin='/administrador'
      ...
      <div className='hijo2_header text-center col-12  '>
        <button 
      ...
      >
        <span className="navbar-toggler-icon text-center col-12 "></span>
      </button>
    
      <div className="collapse navbar-collapse text-center col-12  " id="menu">
