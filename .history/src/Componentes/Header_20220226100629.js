...
import {Pizza2,Administrador2,Inicio2,Menu2,Contacto2,Heart2,Home}from '../Elementos/ImagenesSVG';
...
const Header = ({cambiaradministrador,administrador,cambiaradmin}) => {
    ...
    urladmin='/administrador'
      ...
      <li className="nav-item opcion"><a href="#menuu" className="nav-link text-light  opcion" onClick={()=>{cambiaradmin('usuario')}}><Menu2></Menu2> Menu</a></li>
        <li className="nav-item"><BotonTipoNavLinkA to={url1} className="nav-link text-light" onClick={()=>{cambiaradmin('usuario')}}><Inicio2/> Home</BotonTipoNavLinkA></li> 
